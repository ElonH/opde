---
title: "compile.42"
date: 2021-06-29 09:31:48.750015
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/lcdgrilo/compile -j$(nproc) || make package/feeds/packages/lcdgrilo/compile V=s
```

#### Compile.txt

``` bash
Applying ./patches/010-remove-check-dependency.patch using plaintext: 
patching file configure.ac

Applying ./patches/020-vala.patch using plaintext: 
patching file src/lcdgrilo.vala
...
configure: error: you need glib-2.0 installed
make[3]: *** [Makefile:55: /openwrt/build_dir/target-aarch64_cortex-a72_musl/lcdgrilo-0.0.12/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
