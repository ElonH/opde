---
title: "compile.42"
date: 2021-06-29 09:38:24.590658
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/pkg-config/compile -j$(nproc) || make package/feeds/packages/pkg-config/compile V=s
```
...
make[3]: *** [Makefile:59: /openwrt/build_dir/target-aarch64_cortex-a72_musl/pkg-config-0.29.2/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
