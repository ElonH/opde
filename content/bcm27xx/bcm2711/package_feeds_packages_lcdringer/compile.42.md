---
title: "compile.42"
date: 2021-06-29 09:24:23.776507
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/lcdringer/compile -j$(nproc) || make package/feeds/packages/lcdringer/compile V=s
```

#### Compile.txt

``` bash
Applying ./patches/010-disable-check.patch using plaintext: 
...
make[3]: *** [Makefile:60: /openwrt/build_dir/target-aarch64_cortex-a72_musl/lcdringer-0.0.3/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
