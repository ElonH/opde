---
title: "compile.42"
date: 2021-06-29 09:31:48.737652
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/libgee/compile -j$(nproc) || make package/feeds/packages/libgee/compile V=s
```
...
checking for glib-2.0 >= 2.36 gobject-2.0 >= 2.36 gio-2.0 >= 2.36... no
configure: error: Package requirements (glib-2.0 >= 2.36 gobject-2.0 >= 2.36 gio-2.0 >= 2.36) were not met:
...
make[3]: *** [Makefile:77: /openwrt/build_dir/target-aarch64_cortex-a72_musl/libgee-0.20.4/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
