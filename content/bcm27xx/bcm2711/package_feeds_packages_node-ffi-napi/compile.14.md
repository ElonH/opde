---
title: "compile.14"
date: 2021-05-12 23:07:11.785268
hidden: false
draft: false
weight: -14
---
...
npm http fetch GET 200 https://registry.npmjs.org/debug 158ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 165ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 71ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 110ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 373ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 407ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 434ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 432ms
...
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 150ms
npm http fetch GET 200 https://registry.npmjs.org/ms 54ms
npm http fetch GET 200 https://registry.npmjs.org/ms/-/ms-2.1.2.tgz 44ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 570ms
...
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 82ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 59ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 1485ms
npm timing stage:loadIdealTree Completed in 1492ms
npm timing stage:generateActionsToTake Completed in 6ms
npm timing action:extract Completed in 142ms
npm timing action:finalize Completed in 25ms
...
npm timing action:install Completed in 3658ms
...
npm timing stage:runTopLevelLifecycles Completed in 5405ms
...
npm timing npm Completed in 5718ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-kubI5YoOI5/_logs/2021-05-12T12_12_12_324Z-debug.log
