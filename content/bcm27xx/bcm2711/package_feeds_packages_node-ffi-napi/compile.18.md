---
title: "compile.18"
date: 2021-05-14 07:48:29.309604
hidden: false
draft: false
weight: -18
---
...
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 117ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 119ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 118ms
npm http fetch GET 200 https://registry.npmjs.org/debug 134ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 79ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 80ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 66ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 81ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 455ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 23ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 492ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 60ms
npm http fetch GET 200 https://registry.npmjs.org/ms 27ms
npm http fetch GET 200 https://registry.npmjs.org/ms/-/ms-2.1.2.tgz 45ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 418ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h/-/get-symbol-from-current-process-h-1.0.2.tgz 24ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 56ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 25ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 1201ms
npm timing stage:loadIdealTree Completed in 1206ms
npm timing stage:generateActionsToTake Completed in 4ms
npm timing action:extract Completed in 138ms
...
> ffi-napi@4.0.3 install /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib/node_modules/ffi-napi
> node-gyp-build
...
npm timing action:install Completed in 2562ms
npm WARN rollback Rolling back get-symbol-from-current-process-h@1.0.2 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/get-symbol-from-current-process-h is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back ms@2.1.2 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/ms is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back debug@4.3.1 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/debug is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back node-gyp-build@4.2.3 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/node-gyp-build is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back node-addon-api@2.0.2 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/ref-napi/node_modules/node-addon-api is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back debug@3.2.7 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/ref-struct-di/node_modules/debug is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back get-uv-event-loop-napi-h@1.0.6 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/get-uv-event-loop-napi-h is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back node-addon-api@3.1.0 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/node-addon-api is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back ref-napi@3.0.2 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/ref-napi is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm WARN rollback Rolling back ref-struct-di@1.1.1 failed (this is probably harmless): /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/node_modules/ref-struct-di is not a child of /openwrt/build_dir/target-aarch64_cortex-a72_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
npm timing stage:rollbackFailedOptional Completed in 3ms
npm timing stage:runTopLevelLifecycles Completed in 4012ms
...
npm timing npm Completed in 4263ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-QoqdrMHZ6R/_logs/2021-05-14T06_04_19_238Z-debug.log
