---
title: "compile.20"
date: 2021-05-15 12:14:22.211726
hidden: false
draft: false
weight: -20
---
...
npm http fetch GET 200 https://registry.npmjs.org/debug 123ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 120ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 130ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 77ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 77ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 73ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 474ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 493ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 24ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 19ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 560ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 64ms
npm http fetch GET 200 https://registry.npmjs.org/ms 18ms
npm http fetch GET 200 https://registry.npmjs.org/ms/-/ms-2.1.2.tgz 31ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 387ms
...
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 47ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 19ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 1212ms
npm timing stage:loadIdealTree Completed in 1219ms
npm timing stage:generateActionsToTake Completed in 5ms
npm timing action:extract Completed in 128ms
...
npm timing action:install Completed in 3049ms
...
npm timing stage:runTopLevelLifecycles Completed in 4516ms
...
npm timing npm Completed in 4837ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-WORujH41aF/_logs/2021-05-15T10_19_56_164Z-debug.log
