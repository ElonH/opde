---
title: "compile.42"
date: 2021-06-29 09:32:34.505265
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/gst1-plugins-good/compile -j$(nproc) || make package/feeds/packages/gst1-plugins-good/compile V=s
```

#### Compile.txt

``` bash
Makefile:291: WARNING: skipping gstreamer1-plugins-good -- package has no install section

Applying ./patches/010-distutils.patch using plaintext: 
patching file meson.build
The Meson build system
Version: 0.57.2
Source dir: /openwrt/build_dir/target-aarch64_cortex-a72_musl/gst-plugins-good-1.18.4
Build dir: /openwrt/build_dir/target-aarch64_cortex-a72_musl/gst-plugins-good-1.18.4/openwrt-build
...
../../../../build_dir/target-aarch64_cortex-a72_musl/gst-plugins-good-1.18.4/meson.build:236:0: ERROR: Neither a subproject directory nor a gstreamer.wrap file was found.

A full log can be found at /openwrt/build_dir/target-aarch64_cortex-a72_musl/gst-plugins-good-1.18.4/openwrt-build/meson-logs/meson-log.txt
make[3]: *** [Makefile:228: /openwrt/build_dir/target-aarch64_cortex-a72_musl/gst-plugins-good-1.18.4/.configured_d88fa967f73b98d369eeb96b296d7649] Error 1
```
