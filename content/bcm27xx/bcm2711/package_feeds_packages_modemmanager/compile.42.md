---
title: "compile.42"
date: 2021-06-29 09:33:27.247975
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/modemmanager/compile -j$(nproc) || make package/feeds/packages/modemmanager/compile V=s
```
...
checking for MM... no
configure: error: Package requirements (glib-2.0 >= 2.48.0
                  gmodule-2.0
                  gobject-2.0
                  gio-2.0
...
make[3]: *** [Makefile:142: /openwrt/build_dir/target-aarch64_cortex-a72_musl/ModemManager-1.16.6/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
