---
title: "compile.42"
date: 2021-06-29 09:38:24.591875
hidden: false
draft: false
weight: -42
---
...
make package/feeds/packages/libmbim/compile -j$(nproc) || make package/feeds/packages/libmbim/compile V=s
```
...
checking for MBIM_COMMON... no
configure: error: Package requirements (glib-2.0 >= 2.48) were not met:
...
make[3]: *** [Makefile:98: /openwrt/build_dir/target-aarch64_cortex-a72_musl/libmbim-1.24.8/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
