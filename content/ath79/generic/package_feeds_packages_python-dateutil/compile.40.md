---
title: "compile.40"
date: 2021-06-22 10:50:44.063718
hidden: false
draft: false
weight: -40
---
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmpqknuxi93', '--quiet', 'setuptools_scm']' returned non-zero exit status 2.
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmpqknuxi93', '--quiet', 'setuptools_scm']' returned non-zero exit status 2.
