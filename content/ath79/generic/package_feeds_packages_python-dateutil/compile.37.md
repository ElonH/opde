---
title: "compile.37"
date: 2021-06-20 22:30:11.487057
hidden: false
draft: false
weight: -37
---
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmp7w2t3ftf', '--quiet', 'setuptools_scm']' returned non-zero exit status 2.
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmp7w2t3ftf', '--quiet', 'setuptools_scm']' returned non-zero exit status 2.
