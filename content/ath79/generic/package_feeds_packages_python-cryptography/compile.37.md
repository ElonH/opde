---
title: "compile.37"
date: 2021-06-20 22:39:07.399167
hidden: false
draft: false
weight: -37
---
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmp6npo5uh6', '--quiet', 'setuptools-rust>=0.11.4']' returned non-zero exit status 2.
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmp6npo5uh6', '--quiet', 'setuptools-rust>=0.11.4']' returned non-zero exit status 2.
