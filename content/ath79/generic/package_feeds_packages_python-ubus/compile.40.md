---
title: "compile.40"
date: 2021-06-22 10:44:06.290044
hidden: false
draft: false
weight: -40
---
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmpcr9vj4sp', '--quiet', 'pytest-runner']' returned non-zero exit status 2.
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmpcr9vj4sp', '--quiet', 'pytest-runner']' returned non-zero exit status 2.
