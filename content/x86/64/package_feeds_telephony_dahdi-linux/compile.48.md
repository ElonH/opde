---
title: "compile.48"
date: 2021-02-22 23:42:08.757344
hidden: false
draft: false
weight: -48
---
...
make -C /openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.99 KBUILD_EXTMOD=/openwrt/build_dir/target-x86_64_musl/linux-x86_64/dahdi-linux-3.1.0/drivers/dahdi DAHDI_INCLUDE=/openwrt/build_dir/target-x86_64_musl/linux-x86_64/dahdi-linux-3.1.0/include DAHDI_MODULES_EXTRA=" " HOTPLUG_FIRMWARE=yes modules DAHDI_BUILD_ALL=m
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.99'
...
../dahdi-linux-3.1.0/drivers/dahdi/wctdm24xxp/base.c: In function 'wctdm_check_battery_lost':
../dahdi-linux-3.1.0/drivers/dahdi/wctdm24xxp/base.c:1957:3: warning: this statement may fall through [-Wimplicit-fallthrough=]
   mod_hooksig(wc, mod, DAHDI_RXSIG_ONHOOK);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/wctdm24xxp/base.c:1958:2: note: here
  case BATTERY_PRESENT:
  ^~~~
../dahdi-linux-3.1.0/drivers/dahdi/wctdm24xxp/base.c: In function 'wctdm_check_battery_present':
../dahdi-linux-3.1.0/drivers/dahdi/wctdm24xxp/base.c:2065:3: warning: this statement may fall through [-Wimplicit-fallthrough=]
   mod_hooksig(wc, mod, DAHDI_RXSIG_OFFHOOK);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/wctdm24xxp/base.c:2066:2: note: here
...
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xbus-core.c: In function 'xbus_fill_proc_queue':
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xbus-core.c:1775:76: warning: format '%ld' expects argument of type 'long int', but argument 10 has type 's32' {aka 'int'} [-Wformat=]
   "%-15s: counts %3d, %3d, %3d worst %3d, overflows %3d worst_lag %02lld.%ld ms\n",
                                                                          ~~^
                                                                          %d
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xbus-core.c:1778:3:
   rem);
   ~~~                                                                       
...
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.c: In function '__xframe_dump_queue':
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.c:47:58: warning: format '%ld' expects argument of type 'long int', but argument 6 has type 's32' {aka 'int'} [-Wformat=]
...
In file included from ./include/linux/printk.h:7,
                 ...
                 from ../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.h:4,
                 from ../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.c:2:
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.c: In function '__xframe_enqueue':
...
./include/linux/kern_levels.h:13:21: note: in expansion of macro 'KERN_SOH'
 #define KERN_NOTICE KERN_SOH "5" /* normal but significant condition */
                     ^~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/xpp/dahdi_debug.h:30:9: note: in expansion of macro 'KERN_NOTICE'
  printk(KERN_ ## level "%s%s-%s: " fmt, \
         ^~~~~
../dahdi-linux-3.1.0/drivers/dahdi/xpp/dahdi_debug.h:57:26: note: in expansion of macro 'PRINTK'
 #define NOTICE(fmt, ...) PRINTK(NOTICE, "", fmt, ## __VA_ARGS__)
                          ^~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.c:67:4: note: in expansion of macro 'NOTICE'
    NOTICE("Overflow of %-15s: counts %3d, %3d, %3d worst %3d, overflows %3d worst_lag %02lld.%ld ms\n",
    ^~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/xpp/xframe_queue.c:67:96: note: format string is defined here
    NOTICE("Overflow of %-15s: counts %3d, %3d, %3d worst %3d, overflows %3d worst_lag %02lld.%ld ms\n",
                                                                                              ~~^
                                                                                              %d
...
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c: In function '__dahdi_hooksig_pvt':
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c:8472:6: warning: this statement may fall through [-Wimplicit-fallthrough=]
   if (chan->txstate != DAHDI_TXSTATE_OFFHOOK) break;
      ^
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c:8488:5: note: here
     case DAHDI_SIG_FXSGS:  /* FXS Groundstart */
     ^~~~
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c:8499:6: warning: this statement may fall through [-Wimplicit-fallthrough=]
   if (rxsig == DAHDI_RXSIG_START) {
      ^
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c:8507:5: note: here
     case DAHDI_SIG_FXOLS: /* FXO Loopstart */
     ^~~~
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c: In function '__dahdi_process_getaudio_chunk':
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c:7923:4: warning: this statement may fall through [-Wimplicit-fallthrough=]
    memset(txb + 1, txb[0], DAHDI_CHUNKSIZE - 1);
    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/dahdi-base.c:7925:3: note: here
...
../dahdi-linux-3.1.0/drivers/dahdi/wcte13xp-base.c: In function 't13x_set_linemode':
../dahdi-linux-3.1.0/drivers/dahdi/wcte13xp-base.c:1877:9: warning: this statement may fall through [-Wimplicit-fallthrough=]
   res = t13x_software_init(wc, J1);
         ^~~~~~~~~~~~~~~~~~~~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/wcte13xp-base.c:1878:2: note: here
  default:
  ^~~~~~~
...
../dahdi-linux-3.1.0/drivers/dahdi/wcaxx-base.c: In function 'wcaxx_check_battery_lost':
../dahdi-linux-3.1.0/drivers/dahdi/wcaxx-base.c:1448:3: warning: this statement may fall through [-Wimplicit-fallthrough=]
   mod_hooksig(wc, mod, DAHDI_RXSIG_ONHOOK);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/wcaxx-base.c:1449:2: note: here
  case BATTERY_PRESENT:
  ^~~~
../dahdi-linux-3.1.0/drivers/dahdi/wcaxx-base.c: In function 'wcaxx_check_battery_present':
../dahdi-linux-3.1.0/drivers/dahdi/wcaxx-base.c:1556:3: warning: this statement may fall through [-Wimplicit-fallthrough=]
   mod_hooksig(wc, mod, DAHDI_RXSIG_OFFHOOK);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
../dahdi-linux-3.1.0/drivers/dahdi/wcaxx-base.c:1557:2: note: here
  case BATTERY_LOST: /* intentional drop through */
  ^~~~
...
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.99'
make[4]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/linux-x86_64/dahdi-linux-3.1.0'
grep: /openwrt/build_dir/target-x86_64_musl/linux-x86_64/dahdi-linux-3.1.0/./Module.symvers: No such file or directory
Package kmod-dahdi is missing dependencies for the following libraries:
crc-ccitt.ko
make[3]: *** [Makefile:115: /openwrt/bin/targets/x86/64/packages/kmod-dahdi_5.4.99+3.1.0-4_x86_64.ipk] Error 1
```
