---
title: "compile.41"
date: 2021-06-23 23:13:13.734753
hidden: false
draft: false
weight: -41
---
...
Alternatively, you may set the environment variables CCNET_CFLAGS
and CCNET_LIBS to avoid the need to call pkg-config.
See the pkg-config man page for more details.
make[3]: *** [Makefile:238: /openwrt/build_dir/target-x86_64_musl/seafile-server-7.1.5-server/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
