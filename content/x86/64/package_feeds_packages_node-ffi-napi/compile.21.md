---
title: "compile.21"
date: 2021-05-17 21:37:09.918765
hidden: false
draft: false
weight: -21
---
...
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 143ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 148ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 151ms
npm http fetch GET 200 https://registry.npmjs.org/debug 153ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 152ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 165ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 123ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 132ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 128ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 114ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 130ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.2.0.tgz 130ms
...
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 21ms
...
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 43ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 41ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 558ms
...
npm timing action:preinstall Completed in 6ms
...
npm timing action:install Completed in 3294ms
...
npm WARN rollback Rolling back node-addon-api@3.2.0 failed (this is probably harmless): /openwrt/build_dir/target-x86_64_musl/node-ffi-napi-4.0.3/node_modules/node-addon-api is not a child of /openwrt/build_dir/target-x86_64_musl/node-ffi-napi-4.0.3/ipkg-install/usr/lib
...
npm timing stage:runTopLevelLifecycles Completed in 4134ms
...
npm timing npm Completed in 4469ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-EprJq3YsyW/_logs/2021-05-17T21_03_03_199Z-debug.log
