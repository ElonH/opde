---
title: "compile.19"
date: 2021-05-15 01:41:27.516467
hidden: false
draft: false
weight: -19
---
...
npm http fetch GET 200 https://registry.npmjs.org/debug 168ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 165ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 301ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 136ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 135ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 149ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 311ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 158ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 34ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 53ms
...
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 119ms
...
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 49ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 27ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 712ms
npm timing stage:loadIdealTree Completed in 721ms
npm timing stage:generateActionsToTake Completed in 6ms
npm timing action:extract Completed in 189ms
...
npm timing action:install Completed in 3314ms
...
npm timing stage:runTopLevelLifecycles Completed in 4362ms
...
npm timing npm Completed in 4695ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-NiRDuVhD3m/_logs/2021-05-15T00_50_53_310Z-debug.log
