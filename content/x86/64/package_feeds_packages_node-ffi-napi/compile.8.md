---
title: "compile.8"
date: 2021-05-06 05:07:26.269484
hidden: false
draft: false
weight: -8
---
...
npm timing stage:loadCurrentTree Completed in 46ms
npm timing stage:loadIdealTree:cloneCurrentTree Completed in 1ms
npm timing stage:loadIdealTree:loadShrinkwrap Completed in 1ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 161ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 167ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 169ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 159ms
npm http fetch GET 200 https://registry.npmjs.org/debug 180ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 149ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 163ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 143ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 154ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 162ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 480ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 50ms
npm http fetch GET 200 https://registry.npmjs.org/ms 34ms
npm http fetch GET 200 https://registry.npmjs.org/ms/-/ms-2.1.2.tgz 37ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 36ms
...
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 74ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 38ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 843ms
npm timing stage:loadIdealTree Completed in 851ms
npm timing stage:generateActionsToTake Completed in 6ms
npm timing action:extract Completed in 160ms
...
npm timing action:install Completed in 3001ms
...
npm timing stage:runTopLevelLifecycles Completed in 4144ms
...
npm timing npm Completed in 4492ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-1t0Og4ZNHv/_logs/2021-05-06T00_33_46_508Z-debug.log
