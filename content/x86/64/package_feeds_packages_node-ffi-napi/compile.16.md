---
title: "compile.16"
date: 2021-05-13 20:43:06.859013
hidden: false
draft: false
weight: -16
---
...
npm http fetch GET 200 https://registry.npmjs.org/debug 138ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 134ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 136ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 144ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 144ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 156ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 142ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 132ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 125ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 145ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 145ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 141ms
...
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 26ms
...
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 29ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 557ms
npm timing stage:loadIdealTree Completed in 564ms
npm timing stage:generateActionsToTake Completed in 5ms
npm timing action:extract Completed in 132ms
npm timing action:finalize Completed in 24ms
npm timing action:refresh-package-json Completed in 27ms
...
npm timing action:install Completed in 3303ms
...
npm timing stage:runTopLevelLifecycles Completed in 4107ms
...
npm timing npm Completed in 4396ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-Bm9WmOPTns/_logs/2021-05-13T19_23_03_120Z-debug.log
