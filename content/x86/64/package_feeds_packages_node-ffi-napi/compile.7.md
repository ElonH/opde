---
title: "compile.7"
date: 2021-05-06 04:57:22.552405
hidden: false
draft: false
weight: -7
---
...
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 158ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 162ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 171ms
npm http fetch GET 200 https://registry.npmjs.org/debug 195ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 52ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 55ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 68ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 87ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 405ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 424ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 36ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 100ms
npm http fetch GET 200 https://registry.npmjs.org/ms 41ms
npm http fetch GET 200 https://registry.npmjs.org/ms/-/ms-2.1.2.tgz 74ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 295ms
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h/-/get-symbol-from-current-process-h-1.0.2.tgz 65ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-2.0.2.tgz 64ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-3.2.7.tgz 100ms
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 1225ms
npm timing stage:loadIdealTree Completed in 1232ms
npm timing stage:generateActionsToTake Completed in 5ms
npm timing action:extract Completed in 130ms
...
npm timing action:install Completed in 3041ms
...
npm timing stage:runTopLevelLifecycles Completed in 4514ms
...
npm timing npm Completed in 5010ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-R9E4dlpHXv/_logs/2021-05-05T20_56_04_828Z-debug.log
