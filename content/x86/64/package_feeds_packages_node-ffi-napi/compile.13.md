---
title: "compile.13"
date: 2021-05-11 22:17:02.742137
hidden: false
draft: false
weight: -13
---
...
npm http fetch GET 200 https://registry.npmjs.org/debug 155ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build 156ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi 165ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di 184ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api 189ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h 197ms
npm http fetch GET 200 https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-4.2.3.tgz 140ms
npm http fetch GET 200 https://registry.npmjs.org/debug/-/debug-4.3.1.tgz 147ms
npm http fetch GET 200 https://registry.npmjs.org/ref-struct-di/-/ref-struct-di-1.1.1.tgz 122ms
npm http fetch GET 200 https://registry.npmjs.org/ref-napi/-/ref-napi-3.0.2.tgz 141ms
npm http fetch GET 200 https://registry.npmjs.org/get-uv-event-loop-napi-h/-/get-uv-event-loop-napi-h-1.0.6.tgz 116ms
npm http fetch GET 200 https://registry.npmjs.org/node-addon-api/-/node-addon-api-3.1.0.tgz 122ms
...
npm http fetch GET 200 https://registry.npmjs.org/get-symbol-from-current-process-h 77ms
...
npm timing stage:loadIdealTree:loadAllDepsIntoIdealTree Completed in 639ms
npm timing stage:loadIdealTree Completed in 646ms
npm timing stage:generateActionsToTake Completed in 7ms
npm timing action:extract Completed in 191ms
...
npm timing action:install Completed in 3189ms
...
npm timing stage:runTopLevelLifecycles Completed in 4152ms
...
npm timing npm Completed in 4468ms

npm ERR! A complete log of this run can be found in:
npm ERR!     /openwrt/tmp/npm-cache-uZfpOeNKZQ/_logs/2021-05-11T19_45_22_360Z-debug.log
