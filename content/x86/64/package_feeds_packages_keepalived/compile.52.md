---
title: "compile.52"
date: 2021-03-09 13:46:54.717447
hidden: false
draft: false
weight: -52
---
...
checking linux/netfilter/xt_set.h usability... yes
checking linux/netfilter/xt_set.h presence... yes
checking for linux/netfilter/xt_set.h... yes
checking for struct xt_set_info_match_v1.match_set.index... yes
checking for struct xt_set_info_match_v3.match_set.index... yes
checking for struct xt_set_info_match_v4.match_set.index... yes
checking for libipset version 7 or later... yes
checking whether XT_EXTENSION_MAXNAMELEN is declared... yes
...
------------------------
Keepalived version       : 2.2.1
Compiler                 : ccache_cc x86_64-openwrt-linux-musl-gcc (OpenWrt GCC 8.4.0 r0-ce3b8611) 8.4.0
...
make[4]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
Making all in lib
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make  all-am
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
  CC       memory.o
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
scheduler.c:1052:2: note: called from here
  list_del_init(&thread->e_list);
  ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from scheduler.h:38,
                 from scheduler.c:47:
scheduler.c: In function 'thread_add_read_sands':
scheduler.c:896:14: warning: inlining failed in call to 'thread_timer_cmp': call is unlikely and code size would grow [-Winline]
 RB_TIMER_CMP(thread);
              ^~~~~~
...
In file included from scheduler.h:40,
                 from scheduler.c:47:
scheduler.c:1131:45: note: called from here
...
In file included from scheduler.h:40,
                 from scheduler.c:47:
scheduler.c:1195:51: note: called from here
...
rbtree.h:297:15: note: in definition of macro 'rb_insert_sort_cached'
   int __cmp = compar(new, __data);   \
               ^~~~~~
scheduler.c:1195:2: note: in expansion of macro 'rb_move_cached'
  rb_move_cached(&thread->master->read, thread, n, thread_timer_cmp);
  ^~~~~~~~~~~~~~
In file included from scheduler.h:38,
                 from scheduler.c:47:
...
In file included from scheduler.h:40,
                 from scheduler.c:47:
scheduler.c:1260:46: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
scheduler.c:953:3: note: called from here
   list_del_init(&thread->e_list);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from scheduler.h:39,
                 from scheduler.c:47:
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
scheduler.c:906:3: note: called from here
   list_del_init(&thread->e_list);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from scheduler.h:38,
                 from scheduler.c:47:
...
In file included from scheduler.h:40,
                 from scheduler.c:47:
scheduler.c:1313:46: note: called from here
...
In file included from scheduler.h:40,
                 from scheduler.c:47:
scheduler.c:1337:52: note: called from here
...
rbtree.h:297:15: note: in definition of macro 'rb_insert_sort_cached'
   int __cmp = compar(new, __data);   \
               ^~~~~~
scheduler.c:1337:2: note: in expansion of macro 'rb_move_cached'
  rb_move_cached(&thread->master->timer, thread, n, thread_timer_cmp);
  ^~~~~~~~~~~~~~
In file included from scheduler.h:38,
                 from scheduler.c:47:
...
In file included from scheduler.h:40,
                 from scheduler.c:47:
scheduler.c:1380:46: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
scheduler.c:1517:3: note: called from here
   list_del_init(&thread->e_list);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from scheduler.h:39,
                 from scheduler.c:47:
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
scheduler.c:1523:3: note: called from here
   list_del_init(&thread->e_list);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from scheduler.h:39,
                 from scheduler.c:47:
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
scheduler.c:1532:3: note: called from here
   list_del_init(&thread->e_list);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from scheduler.h:39,
                 from scheduler.c:47:
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1253:2: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1267:2: note: called from here
  list_del_init(&seq->e_list);
  ^~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from parser.c:57:
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1271:3: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1280:4: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1284:3: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1879:2: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:2410:2: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:2661:7: note: called from here
       list_del_init(&file->e_list);
       ^~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from parser.c:57:
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1990:2: note: called from here
...
list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
parser.c:1848:3: note: called from here
...
<command-line>: note: this is the location of the previous definition
  AR       liblib.a
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
Making all in keepalived
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
Making all in core
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/core'
  CC       main.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
main.c:470:1: warning: inlining failed in call to 'remove_reload_file': call is unlikely and code size would grow [-Winline]
 remove_reload_file(void)
 ^~~~~~~~~~~~~~~~~~
main.c:489:3: note: called from here
   remove_reload_file();
   ^~~~~~~~~~~~~~~~~~~~
...
main.c:470:1: warning: inlining failed in call to 'remove_reload_file': call is unlikely and code size would grow [-Winline]
 remove_reload_file(void)
 ^~~~~~~~~~~~~~~~~~
main.c:928:2: note: called from here
  remove_reload_file();
  ^~~~~~~~~~~~~~~~~~~~
...
main.c:470:1: warning: inlining failed in call to 'remove_reload_file': call is unlikely and code size would grow [-Winline]
 remove_reload_file(void)
 ^~~~~~~~~~~~~~~~~~
main.c:2612:3: note: called from here
   remove_reload_file();
   ^~~~~~~~~~~~~~~~~~~~
  CC       daemon.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
In file included from ../../keepalived/include/vrrp.h:41,
                 from ../../keepalived/include/global_data.h:55,
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 ...
 ^~~~~~~~~~~~~~~~~~
global_data.c:315:3: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:330:4: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:341:4: note: called from here
    free_notify_script(&data->lvs_notify_fifo.script);
    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from ../../keepalived/include/vrrp.h:41,
                 from ../../keepalived/include/global_data.h:55,
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:378:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:377:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:384:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:388:2: note: called from here
  free_notify_script(&data->vrrp_notify_fifo.script);
  ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from ../../keepalived/include/vrrp.h:41,
                 from ../../keepalived/include/global_data.h:55,
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
global_data.c:412:2: note: called from here
  free_notify_script(&data->lvs_notify_fifo.script);
  ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  CC       global_parser.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
../../lib/parser.h:96:1: warning: inlining failed in call to 'set_value_r': call is unlikely and code size would grow [-Winline]
 set_value_r(const vector_t *strvec)
 ^~~~~~~~~~~
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:1526:33: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:1458:36: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:1480:41: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:2013:38: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:443:32: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:169:28: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:158:27: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
global_parser.c:530:34: note: in expansion of macro 'set_value'
...
keepalived_netlink.c:148:1: warning: inlining failed in call to 'addr_is_equal2.isra.2': call is unlikely and code size would grow [-Winline]
 addr_is_equal2(struct ifaddrmsg* ifa, void* addr, ip_address_t* vip_addr, interface_t *ifp, vrrp_t *vrrp)
 ^~~~~~~~~~~~~~
keepalived_netlink.c:225:9: note: called from here
     if (addr_is_equal2(ifa, addr, ip_addr, ifp, vrrp))
         ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
keepalived_netlink.c:148:1: warning: inlining failed in call to 'addr_is_equal2.isra.2': call is unlikely and code size would grow [-Winline]
 addr_is_equal2(struct ifaddrmsg* ifa, void* addr, ip_address_t* vip_addr, interface_t *ifp, vrrp_t *vrrp)
 ^~~~~~~~~~~~~~
keepalived_netlink.c:231:8: note: called from here
    if (addr_is_equal2(ifa, addr, ip_addr, ifp, vrrp))
        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from ../../keepalived/include/check_data.h:42,
                 from ../../keepalived/include/check_api.h:35,
                 from keepalived_netlink.c:54:
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:991:28: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:1035:9: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:1054:11: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:1062:9: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:1081:11: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:1115:11: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
keepalived_netlink.c:1120:12: note: called from here
            inaddr_equal(ifa->ifa_family, &vrrp->saddr, addr.addr);
            ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
keepalived_netlink.c:148:1: warning: inlining failed in call to 'addr_is_equal2.isra.2': call is unlikely and code size would grow [-Winline]
 addr_is_equal2(struct ifaddrmsg* ifa, void* addr, ip_address_t* vip_addr, interface_t *ifp, vrrp_t *vrrp)
 ^~~~~~~~~~~~~~
keepalived_netlink.c:176:9: note: called from here
...
reload_monitor.c:115:1: warning: inlining failed in call to 'cancel_reload': call is unlikely and code size would grow [-Winline]
 cancel_reload(bool log)
 ^~~~~~~~~~~~~
reload_monitor.c:468:2: note: called from here
  cancel_reload(false);
  ^~~~~~~~~~~~~~~~~~~~
  AR       libcore.a
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/core'
Making all in vrrp
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/vrrp'
  CC       vrrp_daemon.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
In file included from ../../keepalived/include/global_data.h:51,
                 from vrrp_data.c:33:
...
../../lib/list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
vrrp_data.c:152:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:177:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:176:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:175:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:174:2: note: called from here
...
../../lib/list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
vrrp_data.c:135:3: note: called from here
...
../../lib/list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
vrrp_data.c:275:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:550:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:549:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:548:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
vrrp_data.c:547:2: note: called from here
...
../../lib/list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
vrrp_data.c:569:2: note: called from here
...
../../lib/list_head.h:134:20: warning: inlining failed in call to 'list_del_init': call is unlikely and code size would grow [-Winline]
 static inline void list_del_init(struct list_head *entry)
                    ^~~~~~~~~~~~~
vrrp_data.c:504:2: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:1014:37: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:1003:17: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:990:26: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:977:22: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:966:23: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:955:24: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:944:24: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:349:19: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:338:24: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:327:25: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:316:26: note: called from here
...
vrrp_parser.c:292:1: warning: inlining failed in call to 'set_vrrp_notify_script.isra.4': call is unlikely and code size would grow [-Winline]
 set_vrrp_notify_script(__attribute__((unused)) const vector_t *strvec, int extra_params)
 ^~~~~~~~~~~~~~~~~~~~~~
vrrp_parser.c:305:26: note: called from here
...
../../lib/utils.h:175:24: warning: inlining failed in call to 'csum_incremental_update32': call is unlikely and code size would grow [-Winline]
 static inline uint16_t csum_incremental_update32(const uint16_t old_csum, const uint32_t old_val, const uint32_t new_val)
                        ^~~~~~~~~~~~~~~~~~~~~~~~~
vrrp.c:456:18: note: called from here
...
../../lib/utils.h:175:24: warning: inlining failed in call to 'csum_incremental_update32': call is unlikely and code size would grow [-Winline]
 static inline uint16_t csum_incremental_update32(const uint16_t old_csum, const uint32_t old_val, const uint32_t new_val)
                        ^~~~~~~~~~~~~~~~~~~~~~~~~
vrrp.c:534:16: note: called from here
...
../../lib/timer.h:86:1: warning: inlining failed in call to 'timer_add_now': call is unlikely and code size would grow [-Winline]
 ...
 ^~~~~~~~~~~~~
vrrp.c:1704:30: note: called from here
...
../../lib/timer.h:86:1: warning: inlining failed in call to 'timer_add_now': call is unlikely and code size would grow [-Winline]
 timer_add_now(timeval_t a)
 ^~~~~~~~~~~~~
vrrp.c:1708:27: note: called from here
...
../../lib/timer.h:86:1: warning: inlining failed in call to 'timer_add_now': call is unlikely and code size would grow [-Winline]
 timer_add_now(timeval_t a)
 ^~~~~~~~~~~~~
vrrp.c:1991:31: note: called from here
    vrrp->garp_refresh_timer = timer_add_now(vrrp->garp_refresh);
                               ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from ../../keepalived/include/vrrp.h:40,
                 from ../../keepalived/include/vrrp_arp.h:31,
...
../../lib/timer.h:86:1: warning: inlining failed in call to 'timer_add_now': call is unlikely and code size would grow [-Winline]
 timer_add_now(timeval_t a)
 ^~~~~~~~~~~~~
vrrp.c:1998:28: note: called from here
    vrrp->vmac_garp_timer = timer_add_now(vrrp->vmac_garp_intvl);
                            ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from ../../keepalived/include/vrrp.h:40,
                 from ../../keepalived/include/vrrp_arp.h:31,
...
../../lib/utils.h:120:19: warning: inlining failed in call to '__ip6_addr_equal': call is unlikely and code size would grow [-Winline]
 static inline int __ip6_addr_equal(const struct in6_addr *a1,
                   ^~~~~~~~~~~~~~~~
../../lib/utils.h:162:10: note: called from here
...
../../lib/timer.h:86:1: warning: inlining failed in call to 'timer_add_now': call is unlikely and code size would grow [-Winline]
 timer_add_now(timeval_t a)
 ^~~~~~~~~~~~~
vrrp.c:4769:37: note: called from here
...
../../lib/list_head.h:199:20: warning: inlining failed in call to 'list_copy': call is unlikely and code size would grow [-Winline]
 static inline void list_copy(struct list_head *dst, struct list_head *src)
                    ^~~~~~~~~
vrrp_ipaddress.c:780:2: note: called from here
...
../../lib/list_head.h:199:20: warning: inlining failed in call to 'list_copy': call is unlikely and code size would grow [-Winline]
 static inline void list_copy(struct list_head *dst, struct list_head *src)
                    ^~~~~~~~~
vrrp_ipaddress.c:779:2: note: called from here
...
../../lib/list_head.h:199:20: warning: inlining failed in call to 'list_copy': call is unlikely and code size would grow [-Winline]
 static inline void list_copy(struct list_head *dst, struct list_head *src)
                    ^~~~~~~~~
vrrp_ipaddress.c:773:2: note: called from here
...
../../lib/list_head.h:199:20: warning: inlining failed in call to 'list_copy': call is unlikely and code size would grow [-Winline]
 static inline void list_copy(struct list_head *dst, struct list_head *src)
                    ^~~~~~~~~
vrrp_ipaddress.c:772:2: note: called from here
...
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
In file included from vrrp_vmac.c:37:
vrrp_vmac.c: In function 'netlink_update_vrf':
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_vmac.c:701:2: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_vmac.c:285:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_vmac.c:277:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_vmac.c:293:4: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_vmac.c:509:3: note: called from here
   addattr32(&req.n, sizeof(req), IFLA_LINK, vrrp->configured_ifp->ifindex);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from vrrp_vmac.c:37:
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_vmac.c:532:4: note: called from here
    addattr32(&req.n, sizeof(req), IFLA_MASTER, vrrp->configured_ifp->vrf_master_ifp->ifindex);
    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  CC       vrrp_ipsecah.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
In file included from vrrp_iproute.c:45:
vrrp_iproute.c: In function 'netlink_route':
../../keepalived/include/keepalived_netlink.h:120:1: warning: inlining failed in call to 'rta_addattr32': call is unlikely and code size would grow [-Winline]
...
../../keepalived/include/keepalived_netlink.h:120:1: warning: inlining failed in call to 'rta_addattr32': call is unlikely and code size would grow [-Winline]
 rta_addattr32(struct rtattr *rta, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~~~~~
vrrp_iproute.c:451:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:120:1: warning: inlining failed in call to 'rta_addattr32': call is unlikely and code size would grow [-Winline]
 rta_addattr32(struct rtattr *rta, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~~~~~
vrrp_iproute.c:455:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:120:1: warning: inlining failed in call to 'rta_addattr32': call is unlikely and code size would grow [-Winline]
 rta_addattr32(struct rtattr *rta, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~~~~~
vrrp_iproute.c:465:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:120:1: warning: inlining failed in call to 'rta_addattr32': call is unlikely and code size would grow [-Winline]
 rta_addattr32(struct rtattr *rta, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~~~~~
vrrp_iproute.c:475:4: note: called from here
...
../../keepalived/include/keepalived_netlink.h:120:1: warning: inlining failed in call to 'rta_addattr32': call is unlikely and code size would grow [-Winline]
 rta_addattr32(struct rtattr *rta, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~~~~~
vrrp_iproute.c:259:54: note: called from here
...
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
In file included from vrrp_iprule.c:45:
vrrp_iprule.c: In function 'netlink_rule':
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:188:4: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:206:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:209:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:212:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:215:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:224:3: note: called from here
...
../../keepalived/include/keepalived_netlink.h:92:1: warning: inlining failed in call to 'addattr32.constprop': call is unlikely and code size would grow [-Winline]
 addattr32(struct nlmsghdr *n, size_t maxlen, unsigned short type, uint32_t data)
 ^~~~~~~~~
vrrp_iprule.c:271:3: note: called from here
   addattr32(&req.n, sizeof(req), FRA_GOTO, iprule->goto_target);
   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from ../../keepalived/include/vrrp_iproute.h:42,
...
../../keepalived/include/vrrp_ipaddress.h:96:1: warning: inlining failed in call to 'IP_ISEQ': call is unlikely and code size would grow [-Winline]
 ...
 ^~~~~~~
vrrp_iprule.c:70:7: note: called from here
...
../../keepalived/include/vrrp_ipaddress.h:96:1: warning: inlining failed in call to 'IP_ISEQ': call is unlikely and code size would grow [-Winline]
 IP_ISEQ(ip_address_t *X, const ip_address_t *Y)
 ^~~~~~~
vrrp_iprule.c:71:7: note: called from here
...
vrrp_iptables_calls.c:166:10: warning: 'sav_errno' may be used uninitialized in this function [-Wmaybe-uninitialized]
   return ( sav_errno ) ;
          ^
vrrp_iptables_calls.c: In function 'ip6tables_close':
vrrp_iptables_calls.c:319:10: warning: 'sav_errno' may be used uninitialized in this function [-Wmaybe-uninitialized]
   return ( sav_errno ) ;
          ^
  CC       vrrp_ipset.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
<command-line>: note: this is the location of the previous definition
  AR       libvrrp.a
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/vrrp'
Making all in check
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/check'
  CC       check_daemon.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
check_data.c:344:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
check_data.c:343:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
check_data.c:513:2: note: called from here
...
../../lib/notify.h:78:1: warning: inlining failed in call to 'free_notify_script': call is unlikely and code size would grow [-Winline]
 free_notify_script(notify_script_t **script)
 ^~~~~~~~~~~~~~~~~~
check_data.c:512:2: note: called from here
...
../../lib/utils.h:129:20: warning: inlining failed in call to 'sockstorage_equal': call is unlikely and code size would grow [-Winline]
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
check_parser.c:872:20: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
check_parser.c:603:20: note: in expansion of macro 'set_value'
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
check_api.c:565:10: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
check_api.c:591:8: note: called from here
...
../../lib/utils.h:156:20: warning: inlining failed in call to 'inaddr_equal': call is unlikely and code size would grow [-Winline]
 static inline bool inaddr_equal(sa_family_t family, const void *addr1, const void *addr2)
                    ^~~~~~~~~~~~
check_api.c:617:9: note: called from here
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
check_http.c:505:14: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
check_http.c:592:21: note: in expansion of macro 'set_value'
...
../../lib/parser.h:109:26: note: called from here
 #define set_value(str)  (set_value_r(str))
                         ~^~~~~~~~~~~~~~~~~
check_http.c:463:30: note: in expansion of macro 'set_value'
...
../../lib/utils.h:129:20: warning: inlining failed in call to 'sockstorage_equal': call is unlikely and code size would grow [-Winline]
 static inline bool sockstorage_equal(const struct sockaddr_storage *s1,
                    ^~~~~~~~~~~~~~~~~
ipwrapper.c:76:7: note: called from here
...
../../lib/utils.h:129:20: warning: inlining failed in call to 'sockstorage_equal': call is unlikely and code size would grow [-Winline]
 static inline bool sockstorage_equal(const struct sockaddr_storage *s1,
                    ^~~~~~~~~~~~~~~~~
ipwrapper.c:60:8: note: called from here
...
<command-line>: note: this is the location of the previous definition
  AR       libcheck.a
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/check'
Making all in trackers
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/trackers'
  CC       track_file.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
  AR       libtracker.a
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/trackers'
Making all in etc
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
Making all in init
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init'
make[7]: Nothing to be done for 'all'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init'
Making all in init.d
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init.d'
make[7]: Nothing to be done for 'all'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init.d'
Making all in keepalived
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/keepalived'
  CP       keepalived.conf
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/keepalived'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[7]: Nothing to be done for 'all-am'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
  CC       main.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
  CCLD     keepalived
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
Making all in doc
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
Making all in man/man8
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man8'
  EDIT     keepalived.8
fatal: not a git repository (or any of the parent directories): .git
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man8'
Making all in man/man5
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man5'
  EDIT     keepalived.conf.5
fatal: not a git repository (or any of the parent directories): .git
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man5'
Making all in man/man1
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man1'
  EDIT     genhash.1
fatal: not a git repository (or any of the parent directories): .git
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man1'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
make[6]: Nothing to be done for 'all-am'.
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
Making all in genhash
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/genhash'
  CC       main.o
<command-line>: warning: "_FORTIFY_SOURCE" redefined
<command-line>: note: this is the location of the previous definition
<command-line>: warning: "_FORTIFY_SOURCE" redefined
...
<command-line>: note: this is the location of the previous definition
  CCLD     genhash
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/genhash'
Making all in bin_install
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/bin_install'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/bin_install'
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
  EDIT     README
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
make[4]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
make[4]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
Making install in lib
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make  install-am
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make[7]: Nothing to be done for 'install-exec-am'.
make[7]: Nothing to be done for 'install-data-am'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/lib'
...
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/core'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/core'
make[7]: Nothing to be done for 'install-exec-am'.
make[7]: Nothing to be done for 'install-data-am'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/core'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/core'
Making install in vrrp
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/vrrp'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/vrrp'
make[7]: Nothing to be done for 'install-exec-am'.
make[7]: Nothing to be done for 'install-data-am'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/vrrp'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/vrrp'
Making install in check
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/check'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/check'
make[7]: Nothing to be done for 'install-exec-am'.
make[7]: Nothing to be done for 'install-data-am'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/check'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/check'
Making install in trackers
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/trackers'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/trackers'
make[7]: Nothing to be done for 'install-exec-am'.
make[7]: Nothing to be done for 'install-data-am'.
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/trackers'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/trackers'
Making install in etc
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
Making install in init
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init'
make[8]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init'
make[8]: Nothing to be done for 'install-exec-am'.
make[8]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init'
Making install in init.d
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init.d'
make[8]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init.d'
make[8]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/rc.d/init.d'
 /usr/bin/install -c -m 644 keepalived '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/rc.d/init.d'
make[8]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init.d'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/init.d'
Making install in keepalived
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/keepalived'
make[8]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/keepalived'
make[8]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/keepalived'
 /usr/bin/install -c -m 644 keepalived.conf '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/keepalived'
make[8]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/keepalived'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc/keepalived'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[8]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[8]: Nothing to be done for 'install-exec-am'.
make[8]: Nothing to be done for 'install-data-am'.
make[8]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived/etc'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/sbin'
  /usr/bin/install -c keepalived '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/sbin'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/sysconfig'
 /usr/bin/install -c -m 644 etc/sysconfig/keepalived '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/sysconfig'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/keepalived'
...
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man8'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man8'
make[7]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/man/man8'
 /usr/bin/install -c -m 644 keepalived.8 '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/man/man8'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man8'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man8'
Making install in man/man5
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man5'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man5'
make[7]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/man/man5'
 /usr/bin/install -c -m 644 keepalived.conf.5 '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/man/man5'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man5'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man5'
Making install in man/man1
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man1'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man1'
make[7]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/man/man1'
 /usr/bin/install -c -m 644 genhash.1 '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/man/man1'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man1'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc/man/man1'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
make[7]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/share/snmp/mibs'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/keepalived/samples'
 /usr/bin/install -c -m 644 ./samples/client.pem ./samples/dh1024.pem ./samples/keepalived.conf.HTTP_GET.port ./samples/keepalived.conf.IPv6 ./samples/keepalived.conf.PING_CHECK ./samples/keepalived.conf.SMTP_CHECK ./samples/keepalived.conf.SSL_GET ./samples/keepalived.conf.UDP_CHECK ./samples/keepalived.conf.conditional_conf ./samples/keepalived.conf.fwmark ./samples/keepalived.conf.inhibit ./samples/keepalived.conf.misc_check ./samples/keepalived.conf.misc_check_arg ./samples/keepalived.conf.quorum ./samples/keepalived.conf.sample ./samples/keepalived.conf.status_code ./samples/keepalived.conf.track_interface ./samples/keepalived.conf.virtual_server_group ./samples/keepalived.conf.virtualhost ./samples/keepalived.conf.vrrp ./samples/keepalived.conf.vrrp.localcheck ./samples/keepalived.conf.vrrp.lvs_syncd ./samples/keepalived.conf.vrrp.routes ./samples/keepalived.conf.vrrp.rules ./samples/keepalived.conf.vrrp.scripts ./samples/keepalived.conf.vrrp.static_ipaddress ./samples/keepalived.conf.vrrp.sync ./samples/root.pem ./samples/sample.misccheck.smbcheck.sh ./samples/sample_notify_fifo.sh '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/etc/keepalived/samples'
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/doc'
Making install in genhash
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/genhash'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/genhash'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/bin'
  /usr/bin/install -c genhash '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/bin'
make[6]: Nothing to be done for 'install-data-am'.
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/genhash'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/genhash'
Making install in bin_install
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/bin_install'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/bin_install'
make[6]: Nothing to be done for 'install-exec-am'.
make[6]: Nothing to be done for 'install-data-am'.
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/bin_install'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/bin_install'
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
make[6]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/share/doc/keepalived'
 /usr/bin/install -c -m 644 README '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1/ipkg-install/usr/share/doc/keepalived'
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
make[4]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/keepalived-2.2.1'
Package keepalived is missing dependencies for the following libraries:
libip6tc.so.2
make[3]: *** [Makefile:295: /openwrt/bin/packages/x86_64/packages/keepalived_2.2.1-1_x86_64.ipk] Error 1
```
