---
title: "compile.62"
date: 2021-05-05 13:47:48.865941
hidden: false
draft: false
weight: -62
---
...
Applying ./patches/subsys/369-mac80211-don-t-set-set-TDLS-STA-bandwidth-wider-than.patch using plaintext: 
patching file net/mac80211/vht.c

Applying ./patches/subsys/370-mac80211-pause-TX-while-changing-interface-type.patch using plaintext: 
patching file net/mac80211/ieee80211_i.h
patching file net/mac80211/iface.c

Applying ./patches/subsys/371-mac80211-fix-fast-rx-encryption-check.patch using plaintext: 
patching file net/mac80211/rx.c

Applying ./patches/subsys/372-mac80211-fix-station-rate-table-updates-on-assoc.patch using plaintext: 
patching file net/mac80211/driver-ops.c
patching file net/mac80211/rate.c

Applying ./patches/subsys/373-mac80211-fix-potential-overflow-when-multiplying-to-.patch using plaintext: 
patching file net/mac80211/mesh_hwmp.c

Applying ./patches/subsys/374-mac80211-fix-rate-mask-reset.patch using plaintext: 
patching file net/mac80211/cfg.c

Applying ./patches/subsys/375-mac80211-fix-double-free-in-ibss_leave.patch using plaintext: 
patching file net/mac80211/ibss.c
...
patching file drivers/net/wireless/ath/ath10k/mac.c
Hunk #1 succeeded at 4643 (offset -75 lines).
...
patching file drivers/net/wireless/broadcom/brcm80211/brcmfmac/common.c
/openwrt/build_dir/target-x86_64_musl/linux-x86_64/backports-4.19.161-1/include/linux/ath9k_platform.h /openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.115/include/linux/ath9k_platform.h differ: char 1571, line 56
make[3]: *** [Makefile:563: /openwrt/build_dir/target-x86_64_musl/linux-x86_64/backports-4.19.161-1/.configured_8bf20ae24ff8e1329e40259a18fa7cb3] Error 1
```
