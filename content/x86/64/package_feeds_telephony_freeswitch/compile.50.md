---
title: "compile.50"
date: 2021-02-25 14:20:49.087551
hidden: false
draft: false
weight: -50
---
...
Applying ./patches/040-gentls_cert_update_message_digest.patch using plaintext: 
patching file scripts/gentls_cert.in
...
Applying ./patches/270-fix-uclibc-iconv-in-gsmopen.patch using plaintext: 
...
Applying ./patches/340-mod-spandsp-fix-typo.patch using plaintext: 
patching file src/mod/applications/mod_spandsp/Makefile.am

Applying ./patches/350-gsmopen-spandsp-fixup.patch using plaintext: 
patching file src/mod/endpoints/mod_gsmopen/Makefile.am
...
Applying ./patches/410-mod_rayo_enable-f-no-common-compilation.patch using plaintext: 
patching file src/mod/event_handlers/mod_rayo/iks_helpers.h

Applying ./patches/420-time.patch using plaintext: 
patching file src/include/switch_platform.h
...
aclocal.m4:1153: warning: file `build/config/ac_gcc_x86_cpuid.m4' included several times
aclocal.m4:1154: warning: file `build/config/ac_gcc_archflag.m4' included several times
aclocal.m4:1155: warning: file `build/config/ax_check_compiler_flags.m4' included several times
aclocal.m4:1156: warning: file `build/config/ax_cc_maxopt.m4' included several times
aclocal.m4:1157: warning: file `build/config/ax_cflags_warn_all_ansi.m4' included several times
aclocal.m4:1158: warning: file `build/config/ax_compiler_vendor.m4' included several times
OpenWrt-libtoolize: putting auxiliary files in AC_CONFIG_AUX_DIR, `build'.
OpenWrt-libtoolize: linking file `build/config.guess'
OpenWrt-libtoolize: linking file `build/config.sub'
OpenWrt-libtoolize: linking file `build/install-sh'
...
OpenWrt-libtoolize: You should add the contents of `build/libtool.m4' to `aclocal.m4'.
OpenWrt-libtoolize: linking file `build/ltoptions.m4'
OpenWrt-libtoolize: You should add the contents of `build/ltoptions.m4' to `aclocal.m4'.
OpenWrt-libtoolize: linking file `build/ltsugar.m4'
OpenWrt-libtoolize: You should add the contents of `build/ltsugar.m4' to `aclocal.m4'.
OpenWrt-libtoolize: linking file `build/ltversion.m4'
OpenWrt-libtoolize: linking file `build/lt~obsolete.m4'
OpenWrt-libtoolize: You should add the contents of `build/lt~obsolete.m4' to `aclocal.m4'.
...
OpenWrt-libtoolize: rerunning libtoolize, to keep the correct libtool macros in-tree.
OpenWrt-libtoolize: Consider adding `-I m4' to ACLOCAL_AMFLAGS in Makefile.am.
tests/unit/Makefile.am:6: warning: AM_LDFLAGS multiply defined in condition TRUE ...
build/modmake.rulesam:4: ... 'AM_LDFLAGS' previously defined here
tests/unit/Makefile.am:1:   'build/modmake.rulesam' included from here
tests/unit/Makefile.am:8: warning: AM_CFLAGS multiply defined in condition TRUE ...
build/modmake.rulesam:2: ... 'AM_CFLAGS' previously defined here
tests/unit/Makefile.am:1:   'build/modmake.rulesam' included from here
tests/unit/Makefile.am:9: warning: AM_CPPFLAGS multiply defined in condition TRUE ...
build/modmake.rulesam:3: ... 'AM_CPPFLAGS' previously defined here
tests/unit/Makefile.am:1:   'build/modmake.rulesam' included from here
...
checking for sofia-sip-ua >= 1.12.12... yes
...
checking for ImageMagick >= 6.0.0... yes
checking MAGICK_CFLAGS... -I/usr/include/ImageMagick-7 -I/openwrt/staging_dir/target-x86_64_musl/usr/include/ImageMagick-7 -DMAGICKCORE_HDRI_ENABLE=0 -DMAGICKCORE_QUANTUM_DEPTH=8 
checking MAGICK_LIBS... -L/openwrt/staging_dir/target-x86_64_musl/usr/lib -lMagickCore-7.Q8 
checking for ImageMagick >= 7.0.0... yes
checking MAGICK7_CFLAGS... -I/usr/include/ImageMagick-7 -I/openwrt/staging_dir/target-x86_64_musl/usr/include/ImageMagick-7 -DMAGICKCORE_HDRI_ENABLE=0 -DMAGICKCORE_QUANTUM_DEPTH=8 
checking MAGICK7_LIBS... -L/openwrt/staging_dir/target-x86_64_musl/usr/lib -lMagickCore-7.Q8 
...
checking for perl... /openwrt/staging_dir/hostpkg/usr/bin/perl5.28.1
...
configure: Your erlang seems OK, do not forget to enable mod_erlang_event in modules.conf
  setting CONFIGURE_CFLAGS to "-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include "
...
config.status: executing depfiles commands
config.status: executing libtool commands
=== configuring in libs/apr (/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr)
configure: running /bin/bash ./configure.gnu --disable-option-checking '--prefix=/usr'  '--target=x86_64-openwrt-linux' '--host=x86_64-openwrt-linux' '--build=x86_64-pc-linux-gnu' '--program-prefix=' '--program-suffix=' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/lib' '--sysconfdir=/etc' '--datadir=/usr/share' '--localstatedir=/var' '--mandir=/usr/man' '--infodir=/usr/info' '--disable-nls' '--disable-dependency-tracking' '--disable-static' '--disable-system-xmlrpc-c' '--enable-core-libedit-support' '--enable-fhs' '--with-cachedir=/tmp/freeswitch/cache' '--with-dbdir=/tmp/freeswitch/db' '--with-imagesdir=/usr/share/freeswitch/images' '--with-logfiledir=/tmp/freeswitch/log' '--with-python=no' '--with-recordingsdir=/tmp/freeswitch/recordings' '--with-storagedir=/tmp/freeswitch/storage' '--disable-debug' '--enable-libyuv' '--enable-core-odbc-support' '--enable-srtp' '--enable-libvpx' '--enable-zrtp' '--with-odbc-lib=/openwrt/staging_dir/target-x86_64_musl/usr/lib' '--with-odbc=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-libpri=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-pritap' '--without-pgsql' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-openwrt-linux' 'target_alias=x86_64-openwrt-linux' 'CC=ccache_cc' 'CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' 'CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CXX=ccache_cxx' 'CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' '--with-modinstdir=/usr/lib/freeswitch/mod' 'CONFIGURE_CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' --cache-file=/dev/null --srcdir=.
configure: loading site script /openwrt/include/site/x86_64
checking build system type... x86_64-pc-linux-gnu
checking host system type... x86_64-openwrt-linux-gnu
...
checking whether to build shared libraries... no
checking whether to build static libraries... yes
grep: /openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr/libtool: No such file or directory
...
=== configuring in libs/apr-util (/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr-util)
configure: running /bin/bash ./configure.gnu --disable-option-checking '--prefix=/usr'  '--target=x86_64-openwrt-linux' '--host=x86_64-openwrt-linux' '--build=x86_64-pc-linux-gnu' '--program-prefix=' '--program-suffix=' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/lib' '--sysconfdir=/etc' '--datadir=/usr/share' '--localstatedir=/var' '--mandir=/usr/man' '--infodir=/usr/info' '--disable-nls' '--disable-dependency-tracking' '--disable-static' '--disable-system-xmlrpc-c' '--enable-core-libedit-support' '--enable-fhs' '--with-cachedir=/tmp/freeswitch/cache' '--with-dbdir=/tmp/freeswitch/db' '--with-imagesdir=/usr/share/freeswitch/images' '--with-logfiledir=/tmp/freeswitch/log' '--with-python=no' '--with-recordingsdir=/tmp/freeswitch/recordings' '--with-storagedir=/tmp/freeswitch/storage' '--disable-debug' '--enable-libyuv' '--enable-core-odbc-support' '--enable-srtp' '--enable-libvpx' '--enable-zrtp' '--with-odbc-lib=/openwrt/staging_dir/target-x86_64_musl/usr/lib' '--with-odbc=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-libpri=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-pritap' '--without-pgsql' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-openwrt-linux' 'target_alias=x86_64-openwrt-linux' 'CC=ccache_cc' 'CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' 'CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CXX=ccache_cxx' 'CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' '--with-modinstdir=/usr/lib/freeswitch/mod' 'CONFIGURE_CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' --cache-file=/dev/null --srcdir=.
configure: loading site script /openwrt/include/site/x86_64
checking build system type... x86_64-pc-linux-gnu
checking host system type... x86_64-openwrt-linux-gnu
...
xml/expat configured properly
  setting APRUTIL_EXPORT_LIBS to "/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr-util/xml/expat/lib/libexpat.la"
  setting APRUTIL_INCLUDES to "-I/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr-util/xml/expat/lib"
  setting APRUTIL_LDFLAGS to "-L/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr-util/xml/expat/lib"
  setting APRUTIL_LIBS to "/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr-util/xml/expat/lib/libexpat.la"
...
checking style of crypt_r... struct_crypt_data
  adding "/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/apr/libapr-1.la" to APRUTIL_LIBS
...
config.status: executing default commands
=== configuring in libs/iksemel (/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/iksemel)
configure: running /bin/bash ./configure.gnu --disable-option-checking '--prefix=/usr'  '--target=x86_64-openwrt-linux' '--host=x86_64-openwrt-linux' '--build=x86_64-pc-linux-gnu' '--program-prefix=' '--program-suffix=' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/lib' '--sysconfdir=/etc' '--datadir=/usr/share' '--localstatedir=/var' '--mandir=/usr/man' '--infodir=/usr/info' '--disable-nls' '--disable-dependency-tracking' '--disable-static' '--disable-system-xmlrpc-c' '--enable-core-libedit-support' '--enable-fhs' '--with-cachedir=/tmp/freeswitch/cache' '--with-dbdir=/tmp/freeswitch/db' '--with-imagesdir=/usr/share/freeswitch/images' '--with-logfiledir=/tmp/freeswitch/log' '--with-python=no' '--with-recordingsdir=/tmp/freeswitch/recordings' '--with-storagedir=/tmp/freeswitch/storage' '--disable-debug' '--enable-libyuv' '--enable-core-odbc-support' '--enable-srtp' '--enable-libvpx' '--enable-zrtp' '--with-odbc-lib=/openwrt/staging_dir/target-x86_64_musl/usr/lib' '--with-odbc=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-libpri=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-pritap' '--without-pgsql' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-openwrt-linux' 'target_alias=x86_64-openwrt-linux' 'CC=ccache_cc' 'CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' 'CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CXX=ccache_cxx' 'CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' '--with-modinstdir=/usr/lib/freeswitch/mod' 'CONFIGURE_CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' --cache-file=/dev/null --srcdir=.
configure: loading site script /openwrt/include/site/x86_64
checking for a BSD-compatible install... /usr/bin/install -c
checking whether build environment is sane... yes
...
config.status: executing depfiles commands
config.status: executing libtool commands
=== configuring in libs/libdingaling (/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/libdingaling)
configure: running /bin/bash ./configure.gnu --disable-option-checking '--prefix=/usr'  '--target=x86_64-openwrt-linux' '--host=x86_64-openwrt-linux' '--build=x86_64-pc-linux-gnu' '--program-prefix=' '--program-suffix=' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/lib' '--sysconfdir=/etc' '--datadir=/usr/share' '--localstatedir=/var' '--mandir=/usr/man' '--infodir=/usr/info' '--disable-nls' '--disable-dependency-tracking' '--disable-static' '--disable-system-xmlrpc-c' '--enable-core-libedit-support' '--enable-fhs' '--with-cachedir=/tmp/freeswitch/cache' '--with-dbdir=/tmp/freeswitch/db' '--with-imagesdir=/usr/share/freeswitch/images' '--with-logfiledir=/tmp/freeswitch/log' '--with-python=no' '--with-recordingsdir=/tmp/freeswitch/recordings' '--with-storagedir=/tmp/freeswitch/storage' '--disable-debug' '--enable-libyuv' '--enable-core-odbc-support' '--enable-srtp' '--enable-libvpx' '--enable-zrtp' '--with-odbc-lib=/openwrt/staging_dir/target-x86_64_musl/usr/lib' '--with-odbc=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-libpri=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-pritap' '--without-pgsql' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-openwrt-linux' 'target_alias=x86_64-openwrt-linux' 'CC=ccache_cc' 'CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' 'CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CXX=ccache_cxx' 'CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' '--with-modinstdir=/usr/lib/freeswitch/mod' 'CONFIGURE_CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' --cache-file=/dev/null --srcdir=.
configure: loading site script /openwrt/include/site/x86_64
checking for a BSD-compatible install... /usr/bin/install -c
checking whether build environment is sane... yes
...
config.status: executing depfiles commands
config.status: executing libtool commands
=== configuring in libs/freetdm (/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/libs/freetdm)
configure: running /bin/bash ./configure.gnu --disable-option-checking '--prefix=/usr'  '--target=x86_64-openwrt-linux' '--host=x86_64-openwrt-linux' '--build=x86_64-pc-linux-gnu' '--program-prefix=' '--program-suffix=' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/lib' '--sysconfdir=/etc' '--datadir=/usr/share' '--localstatedir=/var' '--mandir=/usr/man' '--infodir=/usr/info' '--disable-nls' '--disable-dependency-tracking' '--disable-static' '--disable-system-xmlrpc-c' '--enable-core-libedit-support' '--enable-fhs' '--with-cachedir=/tmp/freeswitch/cache' '--with-dbdir=/tmp/freeswitch/db' '--with-imagesdir=/usr/share/freeswitch/images' '--with-logfiledir=/tmp/freeswitch/log' '--with-python=no' '--with-recordingsdir=/tmp/freeswitch/recordings' '--with-storagedir=/tmp/freeswitch/storage' '--disable-debug' '--enable-libyuv' '--enable-core-odbc-support' '--enable-srtp' '--enable-libvpx' '--enable-zrtp' '--with-odbc-lib=/openwrt/staging_dir/target-x86_64_musl/usr/lib' '--with-odbc=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-libpri=/openwrt/staging_dir/target-x86_64_musl/usr' '--with-pritap' '--without-pgsql' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-openwrt-linux' 'target_alias=x86_64-openwrt-linux' 'CC=ccache_cc' 'CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' 'CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CXX=ccache_cxx' 'CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' '--with-modinstdir=/usr/lib/freeswitch/mod' 'CONFIGURE_CFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CPPFLAGS=-I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_CXXFLAGS=-Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release=freeswitch-1.10.5.-release -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/include -I/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/include ' 'CONFIGURE_LDFLAGS=-L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib -znow -zrelro -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libiconv-stub/lib -L/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib -Wl,-rpath-link=/openwrt/staging_dir/target-x86_64_musl/usr/lib/libintl-stub/lib ' --cache-file=/dev/null --srcdir=.
configure: loading site script /openwrt/include/site/x86_64
checking for a BSD-compatible install... /usr/bin/install -c
checking whether build environment is sane... yes
...
make[3]: *** [Makefile:1158: /openwrt/build_dir/target-x86_64_musl/freeswitch-1.10.5.-release/.configured_0cbdd2e8d107e5a00cab47d4c35c864b] Error 1
```
