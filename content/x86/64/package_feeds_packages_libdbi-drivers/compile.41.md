---
title: "compile.41"
date: 2021-06-23 23:20:13.557953
hidden: false
draft: false
weight: -41
---
...
checking for MySQL includes... -I/openwrt/staging_dir/target-x86_64_musl/usr/include/mysql
checking for MySQL libraries... 
checking for PostgreSQL support... yes
checking for PostgreSQL includes... -I/openwrt/staging_dir/target-x86_64_musl/usr/include
checking for PostgreSQL libraries... -L/openwrt/staging_dir/target-x86_64_musl/usr/lib
...
checking for libdbi library... yes: libs in /openwrt/staging_dir/target-x86_64_musl/usr/lib
...
configure: WARNING: unrecognized options: --disable-nls, --disable-rpath
make[4]: Entering directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0'
make  all-recursive
make[5]: Entering directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0'
Making all in drivers
make[6]: Entering directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0/drivers'
Making all in mysql
make[7]: Entering directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0/drivers/mysql'
/bin/bash ../../libtool  --tag=CC   --mode=compile ccache_cc -DHAVE_CONFIG_H -I. -I../.. -I../.. -I../../include -I/openwrt/staging_dir/target-x86_64_musl/usr/include -I/openwrt/staging_dir/target-x86_64_musl/usr/include/mysql  -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include   -std=gnu99 -Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0=libdbi-drivers-0.9.0 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro  -MT dbd_mysql.lo -MD -MP -MF .deps/dbd_mysql.Tpo -c -o dbd_mysql.lo dbd_mysql.c
OpenWrt-libtool: compile:  ccache_cc -DHAVE_CONFIG_H -I. -I../.. -I../.. -I../../include -I/openwrt/staging_dir/target-x86_64_musl/usr/include -I/openwrt/staging_dir/target-x86_64_musl/usr/include/mysql -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -std=gnu99 -Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0=libdbi-drivers-0.9.0 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -MT dbd_mysql.lo -MD -MP -MF .deps/dbd_mysql.Tpo -c dbd_mysql.c  -fPIC -DPIC -o .libs/dbd_mysql.o
dbd_mysql.c:54:10: fatal error: mysql.h: No such file or directory
 #include <mysql.h>
          ^~~~~~~~~
compilation terminated.
make[7]: *** [Makefile:502: dbd_mysql.lo] Error 1
make[7]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0/drivers/mysql'
make[6]: *** [Makefile:402: all-recursive] Error 1
make[6]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0/drivers'
make[5]: *** [Makefile:453: all-recursive] Error 1
make[5]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0'
make[4]: *** [Makefile:383: all] Error 2
make[4]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0'
make[3]: *** [Makefile:106: /openwrt/build_dir/target-x86_64_musl/libdbi-drivers-0.9.0/.built] Error 2
```
