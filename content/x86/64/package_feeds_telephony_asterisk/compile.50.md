---
title: "compile.50"
date: 2021-02-25 14:20:53.836007
hidden: false
draft: false
weight: -50
---
...
``` bash
Applying ./patches/001-disable-semaphores-on-uclibc-otherwise-allow.patch using plaintext: 
patching file configure.ac
Hunk #1 succeeded at 1037 (offset 2 lines).

Applying ./patches/002-configure-fix-detection-of-re-entrant-resolver-funct.patch using plaintext: 
patching file configure.ac
...
patching file configure.ac
Hunk #1 succeeded at 1210 (offset 2 lines).

Applying ./patches/140-use-default-lua.patch using plaintext: 
patching file configure.ac
Hunk #1 succeeded at 2564 (offset 4 lines).
...
make[3]: *** [Makefile:750: /openwrt/build_dir/target-x86_64_musl/asterisk-18.1.1/.configured_91d67d9c4b0bbd9e75147cae155a012c] Error 1
```
