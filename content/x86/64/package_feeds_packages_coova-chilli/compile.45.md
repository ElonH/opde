---
title: "compile.45"
date: 2021-09-01 09:31:02.660489
hidden: false
draft: false
weight: -45
---
...
make[8]: Entering directory '/openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.143'
...
make[8]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.143'
rm libxt_coova.o
...
make -C /openwrt/build_dir/target-x86_64_musl/linux-x86_64/linux-5.4.143 M=$PWD modules_install;
...
x_tables.ko
make[3]: *** [Makefile:162: /openwrt/bin/targets/x86/64/packages/kmod-ipt-coova_5.4.143+1.6-1_x86_64.ipk] Error 1
```
